...
import { ShoppingCart, Star, CheckCircle, Lock, Award, Snowflake, Flame } from "lucide-react"; // Snowflake ve Flame eklendi
...
export const MarketPage = () => {
  ...
  return (
    <div className="space-y-6 animate-slide-up">
      ...
      {/* --- DEĞİŞİKLİK BURADA: Seri Dondurma En Üste ve Vurgulu Olarak Taşındı --- */}
      ...
      {/* Eski Seri Dondurma Kartı Kaldırıldı */}
    </div>
  );
};